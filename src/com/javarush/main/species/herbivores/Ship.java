...
@Herbivores
public class Ship extends Animal implements Serializable {
    ...
    public Ship(double weight, int maxNumberOnPosition, int maxTravelSpeed, double kgForFullSaturation, boolean ifActionDone) {
