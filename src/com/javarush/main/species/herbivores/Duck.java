...
@Herbivores
public class Duck extends Animal implements Serializable {
   /* private double weight;
    ...
    public Duck(double weight, int maxNumberOnPosition, int maxTravelSpeed, double kgForFullSaturation, boolean ifActionDone) {
